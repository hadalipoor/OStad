...
public:
    ...
    String handlecreate(String UId, int GuestId, int DoorOpened, EBPDateTime TagReadTime);
    String handleupdate(int id, String UId, int GuestId, int DoorOpened, EBPDateTime TagReadTime);
...
String DoorLogApis::handlecreate(String UId, int GuestId, int DoorOpened, EBPDateTime TagReadTime) {
...
String DoorLogApis::handleupdate(int id, String UId, int GuestId, int DoorOpened, EBPDateTime TagReadTime) {
...
String DoorLogApis::callFunction(String functionName, std::map<String, String> parameters) {
    ...
    if (functionName == "create") {
        return handlecreate(parameters["UId"], parameters["GuestId"].toInt(), parameters["DoorOpened"].toInt(), parameters["TagReadTime"]);
    }
    if (functionName == "update") {
        return handleupdate(parameters["id"].toInt(), parameters["UId"], parameters["GuestId"].toInt(), parameters["DoorOpened"].toInt(), parameters["TagReadTime"]);
    }
