...
public:
    ...
    static const String RELAYMANAGER_TURN_ON;
    static const String RELAYMANAGER_TURN_ON_AFTER_DELAY;
    static const String RELAYMANAGER_TURN_OFF;
    static const String RELAYMANAGER_TURN_OFF_AFTER_DELAY;
    static const String RELAYMANAGER_TURN_ON_FOR_DELAY;
    static const String RELAYMANAGER_TURN_OFF_FOR_DELAY;
    static const String RELAYMANAGER_GET_STATE;
    static const String RELAYMANAGER_SET_NORMALLY_OPEN;
    static const String RELAYMANAGER_GET_NORMALLY_OPEN;
    static const String RELAYMANAGER_SET_PIN_NUMBER;
    static const String RELAYMANAGER_GET_PIN_NUMBER;
    static const String RELAYMANAGER_GET_ENTITY;
...
void ModulePermissions::addPermissions(Context* context)
{
    ...
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_TURN_ON, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_TURN_ON_AFTER_DELAY, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_TURN_OFF, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_TURN_OFF_AFTER_DELAY, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_TURN_ON_FOR_DELAY, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_TURN_OFF_FOR_DELAY, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_GET_STATE, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_SET_NORMALLY_OPEN, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_GET_NORMALLY_OPEN, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_SET_PIN_NUMBER, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_GET_PIN_NUMBER, "DevicePermissions");
    context->getSecurity()->addPermissionForAdmin(RELAYMANAGER_GET_ENTITY, "DevicePermissions");    context->getSecurity()->addPermissionForAdmin(LCD_CREATE, "ModuleApis Permissions");
...
const String ModulePermissions::RELAYMANAGER_TURN_ON = "relaymanager_turn_on";
const String ModulePermissions::RELAYMANAGER_TURN_ON_AFTER_DELAY = "relaymanager_turn_on_after_delay";
const String ModulePermissions::RELAYMANAGER_TURN_OFF = "relaymanager_turn_off";
const String ModulePermissions::RELAYMANAGER_TURN_OFF_AFTER_DELAY = "relaymanager_turn_off_after_delay";
const String ModulePermissions::RELAYMANAGER_TURN_ON_FOR_DELAY = "relaymanager_turn_on_for_delay";
const String ModulePermissions::RELAYMANAGER_TURN_OFF_FOR_DELAY = "relaymanager_turn_off_for_delay";
const String ModulePermissions::RELAYMANAGER_GET_STATE = "relaymanager_get_state";
const String ModulePermissions::RELAYMANAGER_SET_NORMALLY_OPEN = "relaymanager_set_normally_open";
const String ModulePermissions::RELAYMANAGER_GET_NORMALLY_OPEN = "relaymanager_get_normally_open";
const String ModulePermissions::RELAYMANAGER_SET_PIN_NUMBER = "relaymanager_set_pin_number";
const String ModulePermissions::RELAYMANAGER_GET_PIN_NUMBER = "relaymanager_get_pin_number";
const String ModulePermissions::RELAYMANAGER_GET_ENTITY = "relaymanager_get_entity";
